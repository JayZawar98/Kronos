...
# ── Data fetcher ──────────────────────────────────────────────────────────────
from kronos.data.fetcher import fetch_binance, fetch_yfinance, fetch_fyers, fetch_indian_stock, DATA_DIR

# ── Virtual Broker ────────────────────────────────────────────────────────────
from kronos.data.repository import init_db, get_portfolio, get_open_positions, get_trade_history, get_setting, set_setting, close_position

from kronos.daemon.trader import start_daemon
...
def load_default_model():
    ...
    global _tokenizer, _model, _predictor
    try:
        from kronos.model.kronos import KronosPredictor, KronosTokenizer, Kronos
...
def _daemon_evaluator(asset):
    # This was the old integrated daemon logic. It has been moved to kronos-daemon.
    pass
